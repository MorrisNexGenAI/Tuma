...
import { MapPin, Home as HomeIcon, Utensils, Scissors, Sparkles, Phone, Mail, Globe } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div className="mb-6 md:mb-0 text-center md:text-left">
              ...
              <p className="text-white/80 max-w-md">
                Discover local services across Liberia - easily connect with quality providers
              </p>
            </div>
